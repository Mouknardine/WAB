...
**Contrainte durable — About montre l'équipe, puis ce qu'elle sait faire.** La page s'ouvre sur un seul grand titre de marque, « On fait les choses sérieusement sans se prendre au sérieux », puis les trois portraits en grand, chacun suivi de son rôle et de sa description. Dessous, une bande « Tout se fait sous le même toit » : le titre et un bouton « Démarrer un projet » à gauche, trois listes de savoir-faire à droite (Design, Développement, Accompagnement). Uniquement des prestations réellement vendues, pas de liste d'outils (les outils restent dans le JSON-LD). Aucune étiquette, aucun texte d'introduction, aucun manifeste, aucune liste de valeurs. La fin du titre principal (« studio digital fondé par deux frères à Lausanne ») reste dans le document pour les moteurs et la navigation vocale, sans être affichée. Aucune page n'affiche plus de petite étiquette au-dessus de son titre.
