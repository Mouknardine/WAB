...
**Pages en ligne** : Accueil (`/`), Réalisations (`/realisations`), About (`/studio`), plus deux pages atteintes par des liens internes et non par le menu — Création de site internet à Lausanne (`/creation-site-internet-lausanne`, page de service dédiée à la requête « création site internet Lausanne ») et Applications sur mesure (`/applications`, fiche détaillée du logiciel de gestion, atteinte par le lien du pied de page).
